 ...
 * change: a joined opponent, an accepted move, or the game ending. Kept small and delta-shaped
 * (a single cell, not the whole grid) so every subscriber can cheaply stay in sync.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
public class MultiplayerGameEvent {
    /** One of {@code PLAYER_JOINED}, {@code MOVE_ACCEPTED}, {@code GAME_ENDED}. */
